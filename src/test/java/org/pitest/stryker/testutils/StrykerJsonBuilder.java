package org.pitest.stryker.testutils;
...
public class StrykerJsonBuilder {
  ...
  public StrykerJsonBuilder() {
    this.stringBuilder = new StringBuilder();
    stringBuilder.append(beginJson);
  }

  public StrykerJsonBuilder addFile(final String fileName) {
  ...
  public StrykerJsonBuilder addFile(final String fileName, final String source,
